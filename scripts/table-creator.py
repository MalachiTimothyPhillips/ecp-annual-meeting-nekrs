...
if __name__ == "__main__":
  ...
  print(table)
  with open("pb146-time-per-solve.tex", "w") as f:
    f.write(table)
  myCSV = dumpCSV(ranks, results, common.methodToName)
  print(myCSV)
  with open("pb146-time-per-solve.csv", "w") as f:
    f.write(myCSV)
  ...
  print(table)
  with open("pb146-work-rate.tex", "w") as f:
    f.write(table)
  myCSV = dumpCSV(ranks, results, common.methodToName)
  print(myCSV)
  with open("pb146-work-rate.csv", "w") as f:
    f.write(myCSV)
  ...
  table = finalizeTable(ranks, results, common.methodToName)
  print(table)
  with open("pb1568-time-per-solve.tex", "w") as f:
    f.write(table)
  myCSV = dumpCSV(ranks, results, common.methodToName)
  print(myCSV)
  with open("pb1568-time-per-solve.csv", "w") as f:
    f.write(myCSV)
  ...
  table = finalizeTable(ranks, results, common.methodToName, "{:.2e}")
  print(table)
  with open("pb1568-work-rate.tex", "w") as f:
    f.write(table)
  myCSV = dumpCSV(ranks, results, common.methodToName)
  print(myCSV)
  with open("pb1568-work-rate.csv", "w") as f:
    f.write(myCSV)
